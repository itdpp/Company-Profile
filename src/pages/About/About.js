      ...
      <main className="h-full w-full">
        ...
        <div className="md:grid md:grid-cols-2 md:mx-8 ">
          <div className="border-slate-950 border-2 shadow-3xl w-fit mx-auto my-12 md:h-48 md:mt-3 md:ml-12 lg:h-60 lg:w-96 xl:h-80 xl:w-[550px]">
            <img className="object-cover w-fit h-40 sm:h-80 md:h-48 lg:w-96 lg:h-60 xl:h-80 xl:w-[550px]" src={GambarAbout} alt="" />
          </div>
          <div className="mx-auto mb-12 text-justify px-7 sm:px-10 ">
            <ul>
              ...
              <li>Manpower kami telah tersebar di berbagai daerah Kalimantan & Sumatera dengan jumlah lebih dari 2500.</li>
        ...
        <div className="text-center my-20 mx-8 ">
          <img className="items-center sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto 2xl:mx-auto" src="https://www.dpp.co.id/wp-content/uploads/2022/04/dpppppppp.png" alt="" />
        ...
        <div className="my-24 md:grid md:grid-cols-2 lg:my-36 xl:mx-12 ">
          <div className="p-6 md:p-4 ">
            <img className="xl:h-24 xl:w-[600px] " src="https://www.uniquip.co.id/wp-content/uploads/2023/01/LOGO-PROVEN-PRODUCTS-PROVEN-SERVICES.png" alt="" />
          </div>
